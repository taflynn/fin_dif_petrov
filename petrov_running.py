...
im_t_steps = 250000 #250000# number of imaginary time steps
t_steps = 0#30000 # number of real time steps (do not go too high as curve fitting can break down)
...
np.savetxt('phi0_N'+str(N)+'.csv',ground_data,delimiter=',',fmt='%18.16f')
